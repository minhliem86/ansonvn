                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="wrap-center">
                            <a href="{!! route('admin.service.create') !!}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Thêm</a>
            ...
            var table = $('table').DataTable({
                ...
                initComplete: function(){
                    ...
                    $('#btn-updateOrder').click(function(){
                        ...
                        $.ajax({
                            url: '{{route("admin.service.postAjaxUpdateOrder")}}',
                            type:'POST',
                    ...
                    $('table.table').on('change','input[name=status]', function(){
                        ...
                        console.log(id_item);
                        $.ajax({
                            url: "{{route('admin.service.updateStatus')}}",
                            type : 'POST',
