...
<head style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 0;">
    ...
    <title style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 0;">An Son Viet Nam</title>
                ...
                <table style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 0; width: 100%;">
                    ...
                    <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 0;">
                        <td style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 0;">
                            ...
                            <h3 style="color: #000; font-family: 'HelveticaNeue-Light', 'Helvetica Neue Light', 'Helvetica Neue', Helvetica, Arial, 'Lucida Grande', sans-serif; font-size: 27px; font-weight: 500; line-height: 1.1; margin: 0; margin-bottom: 15px; padding: 0;">Xin chào {!! $data['name'] !!},</h3>
                            <p class="lead" style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 17px; font-weight: normal; line-height: 1.6; margin: 0; margin-bottom: 10px; padding: 0;">Chúng tôi vừa nhận được một tin nhắn từ bạn. Nhân viên của chúng tôi sẽ kiểm tra email và phản hồi lại cho bạn trong thời gian nhất. Trong thời gian đợi hồi âm bạn có thể tham khảo thêm các sản phẩm của chúng tôi tại website:
                                <a href="http://ansonvn.com" style="color: #2BA6CB; font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 0;">ansonvn.com</a> </p>
